...
**Level:** Intermediate  
**Primary stack:** Python, SQL concepts, Pandas, analytics


## 1. Project Goal

Analyze orders, customers, products, and revenue while preserving the correct grain of each metric.
...
```text
Orders → Clean tables → Analytical joins → KPI layer → Customer/product insights → Report
```
...
Build small relational tables, define primary keys and grain, reproduce important SQL-style queries in Python where useful, and validate row counts after joins.
...
Report revenue, average order value, repeat rate, and cohort-style summaries only with explicit definitions and date ranges.
...
### Explain SQL joins in the context of this project.

**Answer framework:** Define SQL joins, show where it appears in the pipeline, explain one trade-off, and give a concrete example.

**Follow-up:** What assumption would change your answer?

**Practice:** Explain your answer without looking at the README.

### Explain window functions in the context of this project.

**Answer framework:** Define window functions, show where it appears in the pipeline, explain one trade-off, and give a concrete example.

**Follow-up:** What assumption would change your answer?

**Practice:** Explain your answer without looking at the README.

### Explain data grain in the context of this project.

**Answer framework:** Define data grain, show where it appears in the pipeline, explain one trade-off, and give a concrete example.

**Follow-up:** What assumption would change your answer?

**Practice:** Explain your answer without looking at the README.

### Explain KPIs in the context of this project.

**Answer framework:** Define KPIs, show where it appears in the pipeline, explain one trade-off, and give a concrete example.

**Follow-up:** What assumption would change your answer?

**Practice:** Explain your answer without looking at the README.

### Explain cohort analysis in the context of this project.

**Answer framework:** Define cohort analysis, show where it appears in the pipeline, explain one trade-off, and give a concrete example.

**Follow-up:** What assumption would change your answer?

**Practice:** Explain your answer without looking at the README.

### Explain query validation in the context of this project.

**Answer framework:** Define query validation, show where it appears in the pipeline, explain one trade-off, and give a concrete example.
...
### Engineering drill 1: Sql Joins

Write down the current assumption about **SQL joins**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 2: Window Functions

Write down the current assumption about **window functions**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 3: Data Grain

Write down the current assumption about **data grain**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 4: Kpis

Write down the current assumption about **KPIs**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 5: Cohort Analysis

Write down the current assumption about **cohort analysis**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 6: Query Validation

Write down the current assumption about **query validation**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 7: Sql Joins

Write down the current assumption about **SQL joins**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 8: Window Functions

Write down the current assumption about **window functions**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 9: Data Grain

Write down the current assumption about **data grain**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 10: Kpis

Write down the current assumption about **KPIs**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 11: Cohort Analysis

Write down the current assumption about **cohort analysis**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 12: Query Validation

Write down the current assumption about **query validation**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 13: Sql Joins

Write down the current assumption about **SQL joins**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 14: Window Functions

Write down the current assumption about **window functions**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 15: Data Grain

Write down the current assumption about **data grain**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 16: Kpis

Write down the current assumption about **KPIs**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 17: Cohort Analysis

Write down the current assumption about **cohort analysis**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 18: Query Validation

Write down the current assumption about **query validation**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 19: Sql Joins

Write down the current assumption about **SQL joins**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 20: Window Functions

Write down the current assumption about **window functions**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 21: Data Grain

Write down the current assumption about **data grain**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 22: Kpis

Write down the current assumption about **KPIs**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 23: Cohort Analysis

Write down the current assumption about **cohort analysis**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 24: Query Validation

Write down the current assumption about **query validation**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 25: Sql Joins

Write down the current assumption about **SQL joins**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 26: Window Functions

Write down the current assumption about **window functions**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 27: Data Grain

Write down the current assumption about **data grain**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 28: Kpis

Write down the current assumption about **KPIs**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 29: Cohort Analysis

Write down the current assumption about **cohort analysis**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 30: Query Validation

Write down the current assumption about **query validation**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 31: Sql Joins

Write down the current assumption about **SQL joins**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 32: Window Functions

Write down the current assumption about **window functions**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 33: Data Grain

Write down the current assumption about **data grain**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 34: Kpis

Write down the current assumption about **KPIs**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 35: Cohort Analysis

Write down the current assumption about **cohort analysis**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 36: Query Validation

Write down the current assumption about **query validation**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 37: Sql Joins

Write down the current assumption about **SQL joins**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 38: Window Functions

Write down the current assumption about **window functions**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 39: Data Grain

Write down the current assumption about **data grain**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 40: Kpis

Write down the current assumption about **KPIs**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 41: Cohort Analysis

Write down the current assumption about **cohort analysis**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 42: Query Validation

Write down the current assumption about **query validation**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 43: Sql Joins

Write down the current assumption about **SQL joins**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 44: Window Functions

Write down the current assumption about **window functions**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 45: Data Grain

Write down the current assumption about **data grain**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 46: Kpis

Write down the current assumption about **KPIs**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 47: Cohort Analysis

Write down the current assumption about **cohort analysis**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 48: Query Validation

Write down the current assumption about **query validation**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 49: Sql Joins

Write down the current assumption about **SQL joins**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 50: Window Functions

Write down the current assumption about **window functions**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 51: Data Grain

Write down the current assumption about **data grain**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 52: Kpis

Write down the current assumption about **KPIs**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 53: Cohort Analysis

Write down the current assumption about **cohort analysis**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 54: Query Validation

Write down the current assumption about **query validation**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 55: Sql Joins

Write down the current assumption about **SQL joins**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 56: Window Functions

Write down the current assumption about **window functions**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 57: Data Grain

Write down the current assumption about **data grain**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 58: Kpis

Write down the current assumption about **KPIs**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 59: Cohort Analysis

Write down the current assumption about **cohort analysis**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 60: Query Validation

Write down the current assumption about **query validation**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 61: Sql Joins

Write down the current assumption about **SQL joins**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 62: Window Functions

Write down the current assumption about **window functions**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 63: Data Grain

Write down the current assumption about **data grain**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 64: Kpis

Write down the current assumption about **KPIs**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 65: Cohort Analysis

Write down the current assumption about **cohort analysis**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 66: Query Validation

Write down the current assumption about **query validation**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 67: Sql Joins

Write down the current assumption about **SQL joins**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 68: Window Functions

Write down the current assumption about **window functions**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 69: Data Grain

Write down the current assumption about **data grain**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 70: Kpis

Write down the current assumption about **KPIs**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 71: Cohort Analysis

Write down the current assumption about **cohort analysis**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 72: Query Validation

Write down the current assumption about **query validation**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 73: Sql Joins

Write down the current assumption about **SQL joins**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 74: Window Functions

Write down the current assumption about **window functions**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 75: Data Grain

Write down the current assumption about **data grain**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 76: Kpis

Write down the current assumption about **KPIs**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 77: Cohort Analysis

Write down the current assumption about **cohort analysis**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 78: Query Validation

Write down the current assumption about **query validation**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 79: Sql Joins

Write down the current assumption about **SQL joins**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 80: Window Functions

Write down the current assumption about **window functions**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 81: Data Grain

Write down the current assumption about **data grain**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 82: Kpis

Write down the current assumption about **KPIs**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 83: Cohort Analysis

Write down the current assumption about **cohort analysis**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 84: Query Validation

Write down the current assumption about **query validation**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 85: Sql Joins

Write down the current assumption about **SQL joins**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 86: Window Functions

Write down the current assumption about **window functions**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 87: Data Grain

Write down the current assumption about **data grain**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 88: Kpis

Write down the current assumption about **KPIs**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 89: Cohort Analysis

Write down the current assumption about **cohort analysis**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 90: Query Validation

Write down the current assumption about **query validation**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 91: Sql Joins

Write down the current assumption about **SQL joins**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 92: Window Functions

Write down the current assumption about **window functions**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 93: Data Grain

Write down the current assumption about **data grain**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 94: Kpis

Write down the current assumption about **KPIs**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 95: Cohort Analysis

Write down the current assumption about **cohort analysis**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 96: Query Validation

Write down the current assumption about **query validation**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 97: Sql Joins

Write down the current assumption about **SQL joins**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 98: Window Functions

Write down the current assumption about **window functions**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 99: Data Grain

Write down the current assumption about **data grain**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 100: Kpis

Write down the current assumption about **KPIs**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 101: Cohort Analysis

Write down the current assumption about **cohort analysis**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 102: Query Validation

Write down the current assumption about **query validation**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 103: Sql Joins

Write down the current assumption about **SQL joins**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 104: Window Functions

Write down the current assumption about **window functions**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 105: Data Grain

Write down the current assumption about **data grain**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 106: Kpis

Write down the current assumption about **KPIs**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 107: Cohort Analysis

Write down the current assumption about **cohort analysis**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 108: Query Validation

Write down the current assumption about **query validation**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 109: Sql Joins

Write down the current assumption about **SQL joins**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 110: Window Functions

Write down the current assumption about **window functions**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 111: Data Grain

Write down the current assumption about **data grain**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 112: Kpis

Write down the current assumption about **KPIs**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 113: Cohort Analysis

Write down the current assumption about **cohort analysis**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 114: Query Validation

Write down the current assumption about **query validation**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 115: Sql Joins

Write down the current assumption about **SQL joins**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 116: Window Functions

Write down the current assumption about **window functions**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 117: Data Grain

Write down the current assumption about **data grain**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 118: Kpis

Write down the current assumption about **KPIs**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 119: Cohort Analysis

Write down the current assumption about **cohort analysis**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 120: Query Validation

Write down the current assumption about **query validation**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 121: Sql Joins

Write down the current assumption about **SQL joins**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 122: Window Functions

Write down the current assumption about **window functions**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 123: Data Grain

Write down the current assumption about **data grain**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 124: Kpis

Write down the current assumption about **KPIs**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 125: Cohort Analysis

Write down the current assumption about **cohort analysis**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 126: Query Validation

Write down the current assumption about **query validation**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 127: Sql Joins

Write down the current assumption about **SQL joins**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 128: Window Functions

Write down the current assumption about **window functions**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 129: Data Grain

Write down the current assumption about **data grain**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 130: Kpis

Write down the current assumption about **KPIs**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 131: Cohort Analysis

Write down the current assumption about **cohort analysis**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 132: Query Validation

Write down the current assumption about **query validation**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 133: Sql Joins

Write down the current assumption about **SQL joins**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 134: Window Functions

Write down the current assumption about **window functions**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 135: Data Grain

Write down the current assumption about **data grain**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 136: Kpis

Write down the current assumption about **KPIs**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 137: Cohort Analysis

Write down the current assumption about **cohort analysis**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 138: Query Validation

Write down the current assumption about **query validation**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 139: Sql Joins

Write down the current assumption about **SQL joins**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 140: Window Functions

Write down the current assumption about **window functions**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 141: Data Grain

Write down the current assumption about **data grain**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 142: Kpis

Write down the current assumption about **KPIs**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 143: Cohort Analysis

Write down the current assumption about **cohort analysis**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 144: Query Validation

Write down the current assumption about **query validation**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 145: Sql Joins

Write down the current assumption about **SQL joins**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 146: Window Functions

Write down the current assumption about **window functions**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 147: Data Grain

Write down the current assumption about **data grain**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 148: Kpis

Write down the current assumption about **KPIs**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 149: Cohort Analysis

Write down the current assumption about **cohort analysis**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 150: Query Validation

Write down the current assumption about **query validation**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 151: Sql Joins

Write down the current assumption about **SQL joins**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 152: Window Functions

Write down the current assumption about **window functions**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 153: Data Grain

Write down the current assumption about **data grain**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 154: Kpis

Write down the current assumption about **KPIs**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 155: Cohort Analysis

Write down the current assumption about **cohort analysis**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 156: Query Validation

Write down the current assumption about **query validation**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 157: Sql Joins

Write down the current assumption about **SQL joins**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 158: Window Functions

Write down the current assumption about **window functions**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 159: Data Grain

Write down the current assumption about **data grain**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 160: Kpis

Write down the current assumption about **KPIs**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 161: Cohort Analysis

Write down the current assumption about **cohort analysis**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 162: Query Validation

Write down the current assumption about **query validation**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 163: Sql Joins

Write down the current assumption about **SQL joins**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 164: Window Functions

Write down the current assumption about **window functions**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 165: Data Grain

Write down the current assumption about **data grain**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 166: Kpis

Write down the current assumption about **KPIs**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 167: Cohort Analysis

Write down the current assumption about **cohort analysis**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 168: Query Validation

Write down the current assumption about **query validation**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 169: Sql Joins

Write down the current assumption about **SQL joins**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 170: Window Functions

Write down the current assumption about **window functions**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 171: Data Grain

Write down the current assumption about **data grain**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 172: Kpis

Write down the current assumption about **KPIs**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 173: Cohort Analysis

Write down the current assumption about **cohort analysis**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 174: Query Validation

Write down the current assumption about **query validation**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 175: Sql Joins

Write down the current assumption about **SQL joins**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 176: Window Functions

Write down the current assumption about **window functions**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 177: Data Grain

Write down the current assumption about **data grain**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 178: Kpis

Write down the current assumption about **KPIs**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 179: Cohort Analysis

Write down the current assumption about **cohort analysis**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 180: Query Validation

Write down the current assumption about **query validation**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 181: Sql Joins

Write down the current assumption about **SQL joins**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 182: Window Functions

Write down the current assumption about **window functions**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 183: Data Grain

Write down the current assumption about **data grain**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 184: Kpis

Write down the current assumption about **KPIs**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 185: Cohort Analysis

Write down the current assumption about **cohort analysis**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 186: Query Validation

Write down the current assumption about **query validation**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 187: Sql Joins

Write down the current assumption about **SQL joins**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 188: Window Functions

Write down the current assumption about **window functions**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 189: Data Grain

Write down the current assumption about **data grain**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 190: Kpis

Write down the current assumption about **KPIs**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 191: Cohort Analysis

Write down the current assumption about **cohort analysis**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 192: Query Validation

Write down the current assumption about **query validation**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 193: Sql Joins

Write down the current assumption about **SQL joins**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 194: Window Functions

Write down the current assumption about **window functions**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 195: Data Grain

Write down the current assumption about **data grain**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 196: Kpis

Write down the current assumption about **KPIs**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 197: Cohort Analysis

Write down the current assumption about **cohort analysis**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 198: Query Validation

Write down the current assumption about **query validation**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 199: Sql Joins

Write down the current assumption about **SQL joins**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 200: Window Functions

Write down the current assumption about **window functions**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 201: Data Grain

Write down the current assumption about **data grain**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 202: Kpis

Write down the current assumption about **KPIs**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 203: Cohort Analysis

Write down the current assumption about **cohort analysis**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 204: Query Validation

Write down the current assumption about **query validation**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 205: Sql Joins

Write down the current assumption about **SQL joins**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 206: Window Functions

Write down the current assumption about **window functions**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 207: Data Grain

Write down the current assumption about **data grain**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 208: Kpis

Write down the current assumption about **KPIs**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 209: Cohort Analysis

Write down the current assumption about **cohort analysis**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 210: Query Validation

Write down the current assumption about **query validation**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 211: Sql Joins

Write down the current assumption about **SQL joins**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 212: Window Functions

Write down the current assumption about **window functions**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 213: Data Grain

Write down the current assumption about **data grain**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 214: Kpis

Write down the current assumption about **KPIs**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 215: Cohort Analysis

Write down the current assumption about **cohort analysis**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 216: Query Validation

Write down the current assumption about **query validation**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 217: Sql Joins

Write down the current assumption about **SQL joins**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 218: Window Functions

Write down the current assumption about **window functions**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 219: Data Grain

Write down the current assumption about **data grain**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 220: Kpis

Write down the current assumption about **KPIs**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 221: Cohort Analysis

Write down the current assumption about **cohort analysis**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 222: Query Validation

Write down the current assumption about **query validation**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 223: Sql Joins

Write down the current assumption about **SQL joins**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 224: Window Functions

Write down the current assumption about **window functions**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 225: Data Grain

Write down the current assumption about **data grain**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 226: Kpis

Write down the current assumption about **KPIs**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 227: Cohort Analysis

Write down the current assumption about **cohort analysis**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 228: Query Validation

Write down the current assumption about **query validation**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 229: Sql Joins

Write down the current assumption about **SQL joins**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 230: Window Functions

Write down the current assumption about **window functions**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 231: Data Grain

Write down the current assumption about **data grain**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 232: Kpis

Write down the current assumption about **KPIs**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 233: Cohort Analysis

Write down the current assumption about **cohort analysis**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 234: Query Validation

Write down the current assumption about **query validation**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 235: Sql Joins

Write down the current assumption about **SQL joins**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 236: Window Functions

Write down the current assumption about **window functions**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 237: Data Grain

Write down the current assumption about **data grain**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 238: Kpis

Write down the current assumption about **KPIs**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 239: Cohort Analysis

Write down the current assumption about **cohort analysis**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 240: Query Validation

Write down the current assumption about **query validation**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 241: Sql Joins

Write down the current assumption about **SQL joins**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 242: Window Functions

Write down the current assumption about **window functions**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 243: Data Grain

Write down the current assumption about **data grain**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 244: Kpis

Write down the current assumption about **KPIs**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 245: Cohort Analysis

Write down the current assumption about **cohort analysis**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 246: Query Validation

Write down the current assumption about **query validation**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 247: Sql Joins

Write down the current assumption about **SQL joins**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 248: Window Functions

Write down the current assumption about **window functions**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 249: Data Grain

Write down the current assumption about **data grain**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 250: Kpis

Write down the current assumption about **KPIs**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 251: Cohort Analysis

Write down the current assumption about **cohort analysis**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 252: Query Validation

Write down the current assumption about **query validation**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 253: Sql Joins

Write down the current assumption about **SQL joins**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 254: Window Functions

Write down the current assumption about **window functions**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 255: Data Grain

Write down the current assumption about **data grain**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 256: Kpis

Write down the current assumption about **KPIs**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 257: Cohort Analysis

Write down the current assumption about **cohort analysis**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 258: Query Validation

Write down the current assumption about **query validation**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 259: Sql Joins

Write down the current assumption about **SQL joins**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 260: Window Functions

Write down the current assumption about **window functions**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 261: Data Grain

Write down the current assumption about **data grain**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 262: Kpis

Write down the current assumption about **KPIs**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 263: Cohort Analysis

Write down the current assumption about **cohort analysis**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 264: Query Validation

Write down the current assumption about **query validation**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 265: Sql Joins

Write down the current assumption about **SQL joins**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 266: Window Functions

Write down the current assumption about **window functions**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 267: Data Grain

Write down the current assumption about **data grain**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 268: Kpis

Write down the current assumption about **KPIs**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 269: Cohort Analysis

Write down the current assumption about **cohort analysis**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 270: Query Validation

Write down the current assumption about **query validation**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 271: Sql Joins

Write down the current assumption about **SQL joins**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 272: Window Functions

Write down the current assumption about **window functions**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 273: Data Grain

Write down the current assumption about **data grain**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 274: Kpis

Write down the current assumption about **KPIs**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 275: Cohort Analysis

Write down the current assumption about **cohort analysis**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 276: Query Validation

Write down the current assumption about **query validation**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 277: Sql Joins

Write down the current assumption about **SQL joins**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 278: Window Functions

Write down the current assumption about **window functions**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 279: Data Grain

Write down the current assumption about **data grain**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 280: Kpis

Write down the current assumption about **KPIs**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 281: Cohort Analysis

Write down the current assumption about **cohort analysis**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 282: Query Validation

Write down the current assumption about **query validation**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 283: Sql Joins

Write down the current assumption about **SQL joins**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 284: Window Functions

Write down the current assumption about **window functions**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 285: Data Grain

Write down the current assumption about **data grain**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 286: Kpis

Write down the current assumption about **KPIs**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 287: Cohort Analysis

Write down the current assumption about **cohort analysis**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 288: Query Validation

Write down the current assumption about **query validation**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 289: Sql Joins
