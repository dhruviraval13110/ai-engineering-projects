...
**Primary stack:** Python, Pandas, Pydantic-style validation, pytest


## 1. Project Goal

Turn inconsistent expense records into a validated, categorized analytical dataset and summary. The system is designed to teach data contracts, cleaning, aggregation, and reproducibility.
...
```text
Source → Validation → Normalization → Categorization → Aggregation → Report
```
...
Implement a small deterministic pipeline first. Use pure functions for normalization and aggregation, then add tests around currency, dates, categories, duplicate IDs, and invalid records.
...
Start with totals and category distributions. If a classifier is later added, introduce a separate evaluation section; never mix deterministic accounting totals with model-quality metrics.
...
### Explain data contracts in the context of this project.

**Answer framework:** Define data contracts, show where it appears in the pipeline, explain one trade-off, and give a concrete example.
...
### Explain deduplication in the context of this project.

**Answer framework:** Define deduplication, show where it appears in the pipeline, explain one trade-off, and give a concrete example.

**Follow-up:** What assumption would change your answer?

**Practice:** Explain your answer without looking at the README.

### Explain aggregation in the context of this project.

**Answer framework:** Define aggregation, show where it appears in the pipeline, explain one trade-off, and give a concrete example.

**Follow-up:** What assumption would change your answer?

**Practice:** Explain your answer without looking at the README.

### Explain data quality in the context of this project.

**Answer framework:** Define data quality, show where it appears in the pipeline, explain one trade-off, and give a concrete example.

**Follow-up:** What assumption would change your answer?

**Practice:** Explain your answer without looking at the README.

### Explain Pandas in the context of this project.

**Answer framework:** Define Pandas, show where it appears in the pipeline, explain one trade-off, and give a concrete example.

**Follow-up:** What assumption would change your answer?

**Practice:** Explain your answer without looking at the README.

### Explain testing in the context of this project.

**Answer framework:** Define testing, show where it appears in the pipeline, explain one trade-off, and give a concrete example.
...
### Engineering drill 1: Data Contracts

Write down the current assumption about **data contracts**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 2: Validation
...
### Engineering drill 3: Deduplication

Write down the current assumption about **deduplication**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 4: Aggregation

Write down the current assumption about **aggregation**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 5: Data Quality

Write down the current assumption about **data quality**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 6: Pandas

Write down the current assumption about **Pandas**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 7: Testing

Write down the current assumption about **testing**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 8: Data Contracts
...
### Engineering drill 10: Deduplication

Write down the current assumption about **deduplication**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 11: Aggregation

Write down the current assumption about **aggregation**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 12: Data Quality

Write down the current assumption about **data quality**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 13: Pandas

Write down the current assumption about **Pandas**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 14: Testing

Write down the current assumption about **testing**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 15: Data Contracts

Write down the current assumption about **data contracts**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 16: Validation

Write down the current assumption about **validation**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 17: Deduplication

Write down the current assumption about **deduplication**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 18: Aggregation

Write down the current assumption about **aggregation**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 19: Data Quality

Write down the current assumption about **data quality**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 20: Pandas

Write down the current assumption about **Pandas**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 21: Testing

Write down the current assumption about **testing**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 22: Data Contracts

Write down the current assumption about **data contracts**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 23: Validation

Write down the current assumption about **validation**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 24: Deduplication

Write down the current assumption about **deduplication**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 25: Aggregation

Write down the current assumption about **aggregation**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 26: Data Quality

Write down the current assumption about **data quality**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 27: Pandas

Write down the current assumption about **Pandas**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 28: Testing

Write down the current assumption about **testing**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 29: Data Contracts

Write down the current assumption about **data contracts**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 30: Validation

Write down the current assumption about **validation**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 31: Deduplication

Write down the current assumption about **deduplication**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 32: Aggregation

Write down the current assumption about **aggregation**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 33: Data Quality

Write down the current assumption about **data quality**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 34: Pandas

Write down the current assumption about **Pandas**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 35: Testing

Write down the current assumption about **testing**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 36: Data Contracts

Write down the current assumption about **data contracts**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 37: Validation

Write down the current assumption about **validation**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 38: Deduplication

Write down the current assumption about **deduplication**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 39: Aggregation

Write down the current assumption about **aggregation**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 40: Data Quality

Write down the current assumption about **data quality**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 41: Pandas

Write down the current assumption about **Pandas**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 42: Testing

Write down the current assumption about **testing**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 43: Data Contracts

Write down the current assumption about **data contracts**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 44: Validation

Write down the current assumption about **validation**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 45: Deduplication

Write down the current assumption about **deduplication**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 46: Aggregation

Write down the current assumption about **aggregation**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 47: Data Quality

Write down the current assumption about **data quality**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 48: Pandas

Write down the current assumption about **Pandas**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 49: Testing

Write down the current assumption about **testing**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 50: Data Contracts
...
### Engineering drill 52: Deduplication

Write down the current assumption about **deduplication**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 53: Aggregation

Write down the current assumption about **aggregation**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 54: Data Quality

Write down the current assumption about **data quality**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 55: Pandas

Write down the current assumption about **Pandas**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 56: Testing

Write down the current assumption about **testing**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 57: Data Contracts

Write down the current assumption about **data contracts**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 58: Validation

Write down the current assumption about **validation**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 59: Deduplication

Write down the current assumption about **deduplication**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 60: Aggregation

Write down the current assumption about **aggregation**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 61: Data Quality

Write down the current assumption about **data quality**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 62: Pandas

Write down the current assumption about **Pandas**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 63: Testing

Write down the current assumption about **testing**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 64: Data Contracts

Write down the current assumption about **data contracts**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 65: Validation

Write down the current assumption about **validation**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 66: Deduplication

Write down the current assumption about **deduplication**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 67: Aggregation

Write down the current assumption about **aggregation**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 68: Data Quality

Write down the current assumption about **data quality**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 69: Pandas

Write down the current assumption about **Pandas**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 70: Testing

Write down the current assumption about **testing**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 71: Data Contracts

Write down the current assumption about **data contracts**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 72: Validation

Write down the current assumption about **validation**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 73: Deduplication

Write down the current assumption about **deduplication**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 74: Aggregation

Write down the current assumption about **aggregation**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 75: Data Quality

Write down the current assumption about **data quality**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 76: Pandas

Write down the current assumption about **Pandas**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 77: Testing

Write down the current assumption about **testing**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 78: Data Contracts

Write down the current assumption about **data contracts**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 79: Validation

Write down the current assumption about **validation**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 80: Deduplication

Write down the current assumption about **deduplication**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 81: Aggregation

Write down the current assumption about **aggregation**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 82: Data Quality

Write down the current assumption about **data quality**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 83: Pandas

Write down the current assumption about **Pandas**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 84: Testing

Write down the current assumption about **testing**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 85: Data Contracts

Write down the current assumption about **data contracts**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 86: Validation

Write down the current assumption about **validation**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 87: Deduplication

Write down the current assumption about **deduplication**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 88: Aggregation

Write down the current assumption about **aggregation**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 89: Data Quality

Write down the current assumption about **data quality**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 90: Pandas

Write down the current assumption about **Pandas**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 91: Testing

Write down the current assumption about **testing**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 92: Data Contracts
...
### Engineering drill 94: Deduplication

Write down the current assumption about **deduplication**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 95: Aggregation

Write down the current assumption about **aggregation**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 96: Data Quality

Write down the current assumption about **data quality**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 97: Pandas

Write down the current assumption about **Pandas**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 98: Testing

Write down the current assumption about **testing**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 99: Data Contracts

Write down the current assumption about **data contracts**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 100: Validation

Write down the current assumption about **validation**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 101: Deduplication

Write down the current assumption about **deduplication**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 102: Aggregation

Write down the current assumption about **aggregation**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 103: Data Quality

Write down the current assumption about **data quality**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 104: Pandas

Write down the current assumption about **Pandas**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 105: Testing

Write down the current assumption about **testing**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 106: Data Contracts

Write down the current assumption about **data contracts**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 107: Validation

Write down the current assumption about **validation**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 108: Deduplication

Write down the current assumption about **deduplication**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 109: Aggregation

Write down the current assumption about **aggregation**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 110: Data Quality

Write down the current assumption about **data quality**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 111: Pandas

Write down the current assumption about **Pandas**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 112: Testing

Write down the current assumption about **testing**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 113: Data Contracts

Write down the current assumption about **data contracts**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 114: Validation

Write down the current assumption about **validation**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 115: Deduplication

Write down the current assumption about **deduplication**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 116: Aggregation

Write down the current assumption about **aggregation**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 117: Data Quality

Write down the current assumption about **data quality**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 118: Pandas

Write down the current assumption about **Pandas**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 119: Testing

Write down the current assumption about **testing**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 120: Data Contracts

Write down the current assumption about **data contracts**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 121: Validation

Write down the current assumption about **validation**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 122: Deduplication

Write down the current assumption about **deduplication**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 123: Aggregation

Write down the current assumption about **aggregation**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 124: Data Quality

Write down the current assumption about **data quality**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 125: Pandas

Write down the current assumption about **Pandas**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 126: Testing

Write down the current assumption about **testing**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 127: Data Contracts

Write down the current assumption about **data contracts**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 128: Validation

Write down the current assumption about **validation**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 129: Deduplication

Write down the current assumption about **deduplication**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 130: Aggregation

Write down the current assumption about **aggregation**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 131: Data Quality

Write down the current assumption about **data quality**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 132: Pandas

Write down the current assumption about **Pandas**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 133: Testing

Write down the current assumption about **testing**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 134: Data Contracts
...
### Engineering drill 136: Deduplication

Write down the current assumption about **deduplication**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 137: Aggregation

Write down the current assumption about **aggregation**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 138: Data Quality

Write down the current assumption about **data quality**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 139: Pandas

Write down the current assumption about **Pandas**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 140: Testing

Write down the current assumption about **testing**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 141: Data Contracts

Write down the current assumption about **data contracts**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 142: Validation

Write down the current assumption about **validation**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 143: Deduplication

Write down the current assumption about **deduplication**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 144: Aggregation

Write down the current assumption about **aggregation**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 145: Data Quality

Write down the current assumption about **data quality**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 146: Pandas

Write down the current assumption about **Pandas**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 147: Testing

Write down the current assumption about **testing**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 148: Data Contracts

Write down the current assumption about **data contracts**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 149: Validation

Write down the current assumption about **validation**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 150: Deduplication

Write down the current assumption about **deduplication**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 151: Aggregation

Write down the current assumption about **aggregation**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 152: Data Quality

Write down the current assumption about **data quality**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 153: Pandas

Write down the current assumption about **Pandas**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 154: Testing

Write down the current assumption about **testing**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 155: Data Contracts

Write down the current assumption about **data contracts**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 156: Validation

Write down the current assumption about **validation**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 157: Deduplication

Write down the current assumption about **deduplication**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 158: Aggregation

Write down the current assumption about **aggregation**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 159: Data Quality

Write down the current assumption about **data quality**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 160: Pandas

Write down the current assumption about **Pandas**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 161: Testing

Write down the current assumption about **testing**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 162: Data Contracts

Write down the current assumption about **data contracts**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 163: Validation

Write down the current assumption about **validation**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 164: Deduplication

Write down the current assumption about **deduplication**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 165: Aggregation

Write down the current assumption about **aggregation**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 166: Data Quality

Write down the current assumption about **data quality**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 167: Pandas

Write down the current assumption about **Pandas**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 168: Testing

Write down the current assumption about **testing**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 169: Data Contracts

Write down the current assumption about **data contracts**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 170: Validation

Write down the current assumption about **validation**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 171: Deduplication

Write down the current assumption about **deduplication**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 172: Aggregation

Write down the current assumption about **aggregation**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 173: Data Quality

Write down the current assumption about **data quality**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 174: Pandas

Write down the current assumption about **Pandas**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 175: Testing

Write down the current assumption about **testing**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 176: Data Contracts
...
### Engineering drill 178: Deduplication

Write down the current assumption about **deduplication**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 179: Aggregation

Write down the current assumption about **aggregation**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 180: Data Quality

Write down the current assumption about **data quality**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 181: Pandas

Write down the current assumption about **Pandas**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 182: Testing

Write down the current assumption about **testing**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 183: Data Contracts

Write down the current assumption about **data contracts**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 184: Validation

Write down the current assumption about **validation**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 185: Deduplication

Write down the current assumption about **deduplication**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 186: Aggregation

Write down the current assumption about **aggregation**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 187: Data Quality

Write down the current assumption about **data quality**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 188: Pandas

Write down the current assumption about **Pandas**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 189: Testing

Write down the current assumption about **testing**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 190: Data Contracts

Write down the current assumption about **data contracts**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 191: Validation

Write down the current assumption about **validation**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 192: Deduplication

Write down the current assumption about **deduplication**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 193: Aggregation

Write down the current assumption about **aggregation**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 194: Data Quality

Write down the current assumption about **data quality**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 195: Pandas

Write down the current assumption about **Pandas**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 196: Testing

Write down the current assumption about **testing**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 197: Data Contracts

Write down the current assumption about **data contracts**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 198: Validation

Write down the current assumption about **validation**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 199: Deduplication

Write down the current assumption about **deduplication**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 200: Aggregation

Write down the current assumption about **aggregation**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 201: Data Quality

Write down the current assumption about **data quality**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 202: Pandas

Write down the current assumption about **Pandas**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 203: Testing

Write down the current assumption about **testing**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 204: Data Contracts

Write down the current assumption about **data contracts**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 205: Validation

Write down the current assumption about **validation**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 206: Deduplication

Write down the current assumption about **deduplication**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 207: Aggregation

Write down the current assumption about **aggregation**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 208: Data Quality

Write down the current assumption about **data quality**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 209: Pandas

Write down the current assumption about **Pandas**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 210: Testing

Write down the current assumption about **testing**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 211: Data Contracts

Write down the current assumption about **data contracts**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 212: Validation

Write down the current assumption about **validation**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 213: Deduplication

Write down the current assumption about **deduplication**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 214: Aggregation

Write down the current assumption about **aggregation**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 215: Data Quality

Write down the current assumption about **data quality**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 216: Pandas

Write down the current assumption about **Pandas**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 217: Testing

Write down the current assumption about **testing**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 218: Data Contracts
...
### Engineering drill 220: Deduplication

Write down the current assumption about **deduplication**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 221: Aggregation

Write down the current assumption about **aggregation**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 222: Data Quality

Write down the current assumption about **data quality**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 223: Pandas

Write down the current assumption about **Pandas**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 224: Testing

Write down the current assumption about **testing**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 225: Data Contracts

Write down the current assumption about **data contracts**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 226: Validation

Write down the current assumption about **validation**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 227: Deduplication

Write down the current assumption about **deduplication**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 228: Aggregation

Write down the current assumption about **aggregation**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 229: Data Quality

Write down the current assumption about **data quality**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 230: Pandas

Write down the current assumption about **Pandas**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 231: Testing

Write down the current assumption about **testing**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 232: Data Contracts

Write down the current assumption about **data contracts**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 233: Validation

Write down the current assumption about **validation**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 234: Deduplication

Write down the current assumption about **deduplication**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 235: Aggregation

Write down the current assumption about **aggregation**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 236: Data Quality

Write down the current assumption about **data quality**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 237: Pandas

Write down the current assumption about **Pandas**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 238: Testing

Write down the current assumption about **testing**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 239: Data Contracts

Write down the current assumption about **data contracts**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 240: Validation

Write down the current assumption about **validation**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 241: Deduplication

Write down the current assumption about **deduplication**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 242: Aggregation

Write down the current assumption about **aggregation**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 243: Data Quality

Write down the current assumption about **data quality**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 244: Pandas

Write down the current assumption about **Pandas**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 245: Testing

Write down the current assumption about **testing**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 246: Data Contracts

Write down the current assumption about **data contracts**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 247: Validation

Write down the current assumption about **validation**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 248: Deduplication

Write down the current assumption about **deduplication**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 249: Aggregation

Write down the current assumption about **aggregation**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 250: Data Quality

Write down the current assumption about **data quality**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 251: Pandas

Write down the current assumption about **Pandas**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 252: Testing

Write down the current assumption about **testing**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 253: Data Contracts

Write down the current assumption about **data contracts**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 254: Validation

Write down the current assumption about **validation**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 255: Deduplication

Write down the current assumption about **deduplication**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 256: Aggregation

Write down the current assumption about **aggregation**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 257: Data Quality

Write down the current assumption about **data quality**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 258: Pandas

Write down the current assumption about **Pandas**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 259: Testing

Write down the current assumption about **testing**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 260: Data Contracts
...
### Engineering drill 262: Deduplication

Write down the current assumption about **deduplication**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 263: Aggregation

Write down the current assumption about **aggregation**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 264: Data Quality

Write down the current assumption about **data quality**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 265: Pandas

Write down the current assumption about **Pandas**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 266: Testing

Write down the current assumption about **testing**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 267: Data Contracts

Write down the current assumption about **data contracts**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 268: Validation

Write down the current assumption about **validation**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 269: Deduplication

Write down the current assumption about **deduplication**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 270: Aggregation

Write down the current assumption about **aggregation**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 271: Data Quality

Write down the current assumption about **data quality**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 272: Pandas

Write down the current assumption about **Pandas**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 273: Testing

Write down the current assumption about **testing**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 274: Data Contracts

Write down the current assumption about **data contracts**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 275: Validation

Write down the current assumption about **validation**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 276: Deduplication

Write down the current assumption about **deduplication**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 277: Aggregation

Write down the current assumption about **aggregation**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 278: Data Quality

Write down the current assumption about **data quality**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 279: Pandas

Write down the current assumption about **Pandas**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 280: Testing

Write down the current assumption about **testing**, identify one way it could fail in this project, then design a small experiment or test that would provide evidence. Record the observation and the decision it changes. This turns passive reading into an engineering loop.

### Engineering drill 281: Data Contracts
